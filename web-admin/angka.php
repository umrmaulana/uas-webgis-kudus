            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                ...
                                <div class="modal-body">
                                    <form id="updateForm" action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <label for="update-nama">Kecamatan</label>
                                            <input type="text" class="form-control" id="update-nama" name="nama_kec"
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <label for="update-jumlah">Jumlah</label>
                                            <input type="number" class="form-control" id="update-jumlah" name="jumlah"
                                                required>
                                        </div>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        $sql = "UPDATE angka_hiv SET nama_kec = ?, jumlah = ? WHERE id = ?";
                        $stmt = $conn->prepare($sql);
                        $stmt->bind_param("sii", $nama_kec, $jumlah, $id);
